...
inline void avx_mult(cs1300bmp *output, int divisor)
{
    ...
    for(int i = 0; i < 8192; i++)
    {
        ...
        {
            int holder = vectorized1[i][j];
            holder = holder / divisor;    
            holder = holder < 0 ? 0: holder;
            holder = holder > 255 ? 255: holder;
            output -> color[0][i][j] = 255;
            output -> color[1][i][j] = 100;
            output -> color[2][i][j] = 155;
